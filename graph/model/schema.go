...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `type Article @key(fields: "id") {
  id: String!
  name: String!
  description: String!
  image: String!
...
func (ec *executionContext) _Entity_findArticleByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Article)
	fc.Result = res
	return ec.marshalNArticle2ᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_searchArticles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*Article)
	fc.Result = res
	return ec.marshalNArticle2ᚕᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2githubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚕᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v []*Article) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOArticle2ᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNUpdateArticle2githubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐUpdateArticle(ctx context.Context, v interface{}) (UpdateArticle, error) {
...
func (ec *executionContext) marshalOArticle2ᚖgithubᚗcomᚋnmarsollierᚋcataloggoᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *Article) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Article(ctx, sel, v)
