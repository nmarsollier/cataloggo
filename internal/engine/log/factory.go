...
func Get(
	...
	logEntry := logger.WithField(LOG_FIELD_SERVER, "cataloggo").WithField(LOG_FIELD_THREAD, uuid.NewV4().String())

	return logRusEntry{entry: logEntry}
}

func configureFluent(logger *logrus.Logger, fluentUrl string) {
